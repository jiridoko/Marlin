...
#define STRING_CONFIG_H_AUTHOR "Jiri Dokoupil" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Jiriprint mk2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Measured values for jiriprint mk2 hypercube
  #define DEFAULT_bedKp 69.13
  #define DEFAULT_bedKi 12.64
  #define DEFAULT_bedKd 252.13
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.0, 397.29, 473.09 } //417.39
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 200, 1800 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -3, 16, -2.456 }
...
#define PREHEAT_3_FAN_SPEED     77 // Value from 0 to 255
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 44       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
  //#define NEOPIXEL_IS_SEQUENTIAL   // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS 204  // Initial brightness (0-255)
